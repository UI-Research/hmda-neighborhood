...
# check all joins
  ...
  # 2. merge tract_level_income_limits with national dataset subsetted to only Alabama census tracts, where state code is 01 (line 319)
    #

# do final outputs have missing data in the same place that ACS data
# check all joins 
# check vars that were summed, as well as median

# add pipe to where we're reading in the raw data to create subset of all tracts just for 1 state
```
