...
##IS ROWWISE NECESSARY HERE? THIS IS WHY IT TAKES HOURS
nathmda_comb <- nathmda_flags %>%
  ...
  mutate(#Top-line indicators
         ...
         middleage_purch = create_var(middle_age_flag, std_flag),
...
# missingness appears to be valid / intentional
# nathmda_comb_not_rowwise %>% ungroup %>% skim
```
...
final_vars <- c(
  ...
  #Age vars
  "olderage_purch", "middleage_purch", "youngerage_purch", "mixedage_purch",
