...
View(skimr::skim(hmda_2018))
  ...
  # quite a few variables have extreme outliers for the invalid geo (geo2010 == 99999999999). 
    # ex: owner_purchase_originations (originations for first-lien owner-occupied home purchases of 1-4 unit dwellings). is 12,900 for geo 99999999999, next closest is 
    # ex: occupancy_investment_origination (originations for loans made for the purpose of investment purchases)
```
