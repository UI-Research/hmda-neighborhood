...
```{r nathmda colnames, eval = F}
 [1] "activity_year"                            "lei"                                      "derived_msa_md"                          
 [4] "state_code"                               "county_code"                              "census_tract"                            
 [7] "conforming_loan_limit"                    "derived_loan_product_type"                "derived_dwelling_category"               
[10] "derived_ethnicity"                        "derived_race"                             "derived_sex"                             
[13] "action_taken"                             "purchaser_type"                           "preapproval"                             
[16] "loan_type"                                "loan_purpose"                             "lien_status"                             
[19] "reverse_mortgage"                         "open_end_line_of_credit"                  "business_or_commercial_purpose"          
[22] "loan_amount"                              "combined_loan_to_value_ratio"             "interest_rate"                           
[25] "rate_spread"                              "hoepa_status"                             "total_loan_costs"                        
[28] "total_points_and_fees"                    "origination_charges"                      "discount_points"                         
[31] "lender_credits"                           "loan_term"                                "prepayment_penalty_term"                 
[34] "intro_rate_period"                        "negative_amortization"                    "interest_only_payment"                   
[37] "balloon_payment"                          "other_nonamortizing_features"             "property_value"                          
[40] "construction_method"                      "occupancy_type"                           "manufactured_home_secured_property_type" 
[43] "manufactured_home_land_property_interest" "total_units"                              "multifamily_affordable_units"            
[46] "income"                                   "debt_to_income_ratio"                     "applicant_credit_score_type"             
[49] "co_applicant_credit_score_type"           "applicant_ethnicity_1"                    "applicant_ethnicity_2"                   
[52] "applicant_ethnicity_3"                    "applicant_ethnicity_4"                    "applicant_ethnicity_5"                   
[55] "co_applicant_ethnicity_1"                 "co_applicant_ethnicity_2"                 "co_applicant_ethnicity_3"                
[58] "co_applicant_ethnicity_4"                 "co_applicant_ethnicity_5"                 "applicant_ethnicity_observed"            
[61] "co_applicant_ethnicity_observed"          "applicant_race_1"                         "applicant_race_2"                        
[64] "applicant_race_3"                         "applicant_race_4"                         "applicant_race_5"                        
[67] "co_applicant_race_1"                      "co_applicant_race_2"                      "co_applicant_race_3"                     
[70] "co_applicant_race_4"                      "co_applicant_race_5"                      "applicant_race_observed"                 
[73] "co_applicant_race_observed"               "applicant_sex"                            "co_applicant_sex"                        
[76] "applicant_sex_observed"                   "co_applicant_sex_observed"                "applicant_age"                           
[79] "co_applicant_age"                         "applicant_age_above_62"                   "co_applicant_age_above_62"               
[82] "submission_of_application"                "initially_payable_to_institution"         "aus_1"                                   
[85] "aus_2"                                    "aus_3"                                    "aus_4"                                   
[88] "aus_5"                                    "denial_reason_1"                          "denial_reason_2"                         
[91] "denial_reason_3"                          "denial_reason_4"                          "tract_population"                        
[94] "tract_minority_population_percent"        "ffiec_msa_md_median_family_income"        "tract_to_msa_income_percentage"          
[97] "tract_owner_occupied_units"               "tract_one_to_four_family_homes"           "tract_median_age_of_housing_units" 
...
nathmda_in <- read_parquet(rawfile, col_select = hmda_columns) %>%
  #read_delim(rawfile, delim = "|") %>%
    mutate(
...
#column names: 
#state code (two letter abbreviation, capitalized) 
#st_fips (two character numeric FIPS code)
#states <- readRDS(statefile)

#column names: 
#county name (character, capitalized)
#state (two letter abbreviation, capitalized, factor)
#county_fips (three character numeric FIPS code) 
#state_fips (two character numeric FIPS code)
#others..., seemingly unused
#ucounty - derived variable: combined state_fips+county_ips
...
acs_housing = read_csv(here("data-raw", "acs_5yr_2019_owner_occupied_housing.csv"))
  ...
  #merge(nathmda_geo, il_in, by.x = "ucounty", by.y = "ucounty", all.x = TRUE) %>%
    mutate(
      ...
      across(
        ...
        ~ case_when(
          . %in% c("8888", "9999") ~ NA_character_, ##these aren't defined in the documentation; is 8888 not applicable (i.e., no co-applicant?)
      ...
      older_adult_flag = case_when(
        applicant_age == "65+" & co_applicant_age == "65+" ~ 1,
        applicant_age == "65+" & is.na(co_applicant_age) ~ 1,
        is.na(applicant_age) & co_applicant_age == "65+" ~ 1,
        T ~ 0),
      
      middle_adult_flag = case_when(
        applicant_age %in% c("25-44", "45-64") & co_applicant_age %in% c("25-44", "45-64") ~ 1,
        applicant_age %in% c("25-44", "45-64") & is.na(co_applicant_age) ~ 1,
        is.na(applicant_age) & co_applicant_age %in% c("25-44", "45-64") ~ 1,
        T ~ 0),
      
      younger_adult_flag = case_when(
...
nathmda_flags %>% 
  select(matches("age"), matches("adult")) %>%
  skim
...
final_vars <- c(
  ...
  #Age vars
  "older_adult_flag","middle_adult_flag","younger_adult_flag",
  ...
  left_join(
    acs_housing %>%
      mutate(
        ...
        owner_occupied_perc = if_else(housing_units_occupied_total == 0, 0, owner_occupied_perc)
        ) %>%
